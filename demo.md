...
```bash
python main.py sample_logs/clean.log --summary --timeline
```
**Expected Outcome**: 
...
```bash
python main.py sample_logs/gaps.log --threshold 120 --summary --timeline
```
**Expected Outcome**: 
...
```bash
python main.py sample_logs/malformed.log --summary --timeline --verbose
```
**Expected Outcome**: 
...
```bash
python main.py sample_logs/gaps.log --format json > report.json
cat report.json
```
**Expected Outcome**: 
